...
def get_time_query(request):
    ...
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND niv.id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND l.id = " + request.GET.get('letter')
    ...
    start_base = "SELECT u.id, concat(nombres ,' ', apellido_paterno , ' ',apellido_materno) as nombre_alumno, IF (ROUND((SUM(TIMESTAMPDIFF(SECOND, datetime_inicio,datetime_termino))))/60<1, 1,ROUND(SUM(TIMESTAMPDIFF(SECOND, datetime_inicio,datetime_termino))/60)) as total_horas, co.nombre as Colegio, concat(niv.nombre, l.nombre) as Nivel FROM asigna_reim_alumno a, usuario u, pertenece p , letra l , nivel niv, colegio co WHERE" + date
    final_base = ' l.id=p.letra_id and p.nivel_id = niv.id and  a.usuario_id = u.id and p.usuario_id=u.id and co.id = p.colegio_id AND p.colegio_id IN (SELECT colegio_id FROM pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND p.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY u.id'
...
def get_session_query(request):
    ...
    if request.GET.get('reim') and request.GET.get('reim') != '0':
        query_params += " AND a.reim_id = " + request.GET.get('reim')
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND b.nivel_id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(a.usuario_id) AS Sesiones, b.colegio_id, b.nivel_id FROM asigna_reim_alumno a, usuario u, pertenece b WHERE' + date
    final_base = ' a.usuario_id= u.id && b.usuario_id = a.usuario_id && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY u.id'
...
def get_session_PS_query(request):
    ...
    final_base = ' a.usuario_id= u.id && b.usuario_id = a.usuario_id && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' '
...
def get_touch_query(request):
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," " , u.apellido_paterno ," " , u.apellido_materno) as nombre, count(a.id_user) AS CantidadTouch, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY id_user'
...
def get_abejas_porniño(request, id_niño):
    ...
    if request.GET.get('reim') and request.GET.get('reim') != '0':
        query_params += " AND a.id_reim = " + request.GET.get('reim')
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND b.nivel_idd = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
        query_params += " AND b.colegio_id = " + request.GET.get('school')
...
def get_colisiones_analitica_DM(request):
    ...
    if request.GET.get('reim') and request.GET.get('reim') != '0':
        query_params += " AND a.id_reim = " + request.GET.get('reim')
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND b.cnivel_id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
        query_params += " AND b.colegio_id = " + request.GET.get('school')
...
def get_miel_cae_choca(request):
    ...
    if request.GET.get('reim') and request.GET.get('reim') != '0':
        query_params += " AND a.id_reim = " + request.GET.get('reim')
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND bnivel_id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
        query_params += " AND b.colegio_id = " + request.GET.get('school')
...
def get_colision_co(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(a.correcta) AS colisiones, b.colegio_id, b.nivel_idnivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
...
def get_jumps_co(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(a.correcta) AS saltos, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
...
def get_corrects_student_co(request):
    ...
    final_base = '  niv.id=a.id_actividad && a.id_user="' + request.GET.get('student') + '" ' + query_params + ' and a.id_actividad>= 3002 and a.id_actividad<=3007 group by ac.nombre;'
    return start_base + final_base
...
def get_time_act_co(request):
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, IF (ROUND((SUM(TIMESTAMPDIFF(SECOND, a.inicio, a.final))))/60<1, 1,ROUND(SUM(TIMESTAMPDIFF(SECOND, a.inicio, a.final))/60)) as total_min FROM tiempoxactividad a, usuario u, pertenece b , letra l , nivel niv, colegio co WHERE' + date
    final_base = ' l.id=b.letra_id and b.nivel_id = niv.id and a.usuario_id = u.id and b.usuario_id=u.id and co.id = b.colegio_id' + query_params + ' group by u.id;'
    return start_base + final_base
...
def get_piezas(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(a.correcta) AS piezas, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' and ((a.correcta>9 and a.correcta<100) || (a.id_elemento = 35 and a.id_actividad = 5) || (a.id_elemento = 32 and a.id_actividad = 6)) GROUP BY u.id;'
    return start_base + final_base
...
def get_malas(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(a.correcta) AS malas, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' AND (a.correcta=0 OR a.correcta>999) GROUP BY u.id'
    return start_base + final_base
...
def get_animals(request):
    ...
    final_base = ' a.id_elemento=e.id && a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' AND e.id>10 AND e.id<26 GROUP BY e.id'
    return start_base + final_base
...
def get_cant_touch(request):
    ...
    start_base = 'SELECT o.id, o.nombre, count(o.id) AS actividades FROM actividad o, alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_actividad=o.id && a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' AND o.id>0 AND o.id<8 GROUP BY o.id'
    return start_base + final_base
...
def get_interaccion(request):
    ...
    if request.GET.get('reim') and request.GET.get('reim') != '0':
        query_params += " AND a.id_reim = " + request.GET.get('reim')
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND e.nivel_id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
    ...
    final_base = ' e.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND e.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' AND c.usuario_id = d.id and c.usuario_id = e.usuario_id and a.correcta = b.elemento_id and b.asigna_reim_alumno_sesion_id = c.sesion_id and a.datetime_touch > c.datetime_inicio and a.datetime_touch < c.datetime_termino and correcta >9 and correcta<100 group by c.usuario_id;'
    return start_base + final_base
...
def get_tiempoact(request):
    ...
    final_base = ' e.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND e.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' AND a.actividad_id = b.id group by actividad_id;'
    return start_base + final_base
...
# Avance en query tiempo total del nivel por actividad
# SELECT t.id, t.inicio, t.final, t.actividad_id, t.usuario_id, (sum(timestampdiff(minute, inicio, final)))/60 FROM tiempoxactividad t, actividad b, pertenece e where e.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="163465639") AND e.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "163465639")) AND t.reim_id = 1 AND e.nivel_id = 5 AND e.colegio_id = 3 AND t.actividad_id = b.id group by usuario_id;
...
def get_analytics1_co(request):
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(if(a.id_elemento=7,1,NULL)) Actividad1, count(if(a.id_elemento=8,1,NULL)) Actividad2, count(if(a.id_elemento=9,1,NULL)) Actividad3, count(if(a.id_elemento=10,1,NULL)) Actvidad4, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b where' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY u.id'
    return start_base + final_base
...
def get_audios(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(a.id_elemento) AS audios, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' AND (a.id_elemento = 28 OR a.id_elemento = 36 OR a.id_elemento = 48 OR a.id_elemento = 52 OR a.id_elemento = 63 OR a.id_elemento = 64 OR a.id_elemento = 65 OR a.id_elemento = 66 ) GROUP BY u.id'
    return start_base + final_base
...
def get_puzzle_PS(request):
    ...
    start_base = ' SELECT u.id, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, count(a.id_user) AS CantidadTouch, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
...
def get_element_colission_alu_query(request):
    ...
    start_base = ' SELECT  concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, count(a.id_user) AS CantidadTouch, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user' + query_params + ' GROUP BY day(a.datetime_touch) ORDER BY a.datetime_touch ASC'
...
def get_touch_analitica_query(request):
    ...
    start_base = ' SELECT  concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, COALESCE(round(count((if(a.id_elemento=2128,1,null)))/count((if (a.id_elemento=2031,1,null)))),0) AS CantidadTouch, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user ' + query_params + ' GROUP BY day(a.datetime_touch) ORDER BY a.datetime_touch ASC'
...
def get_playtime(request):
    ...
    start_base = "SELECT u.id, concat(nombres ,' ', apellido_paterno , ' ',apellido_materno) as nombre_alumno, IF (ROUND((SUM(TIMESTAMPDIFF(SECOND, datetime_inicio,datetime_termino))))/60<1, 1,ROUND(SUM(TIMESTAMPDIFF(SECOND, datetime_inicio,datetime_termino))/60)) as minutos_juego, co.nombre as Colegio, concat(niv.nombre, l.nombre) as Nivel FROM asigna_reim_alumno a, usuario u, pertenece p , letra l , nivel niv, colegio co WHERE" + date
    final_base = ' l.id=p.letra_id and p.nivel_id = niv.id and  a.usuario_id = u.id and p.usuario_id=u.id and co.id = p.colegio_id AND p.colegio_id IN (SELECT colegio_id FROM pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND p.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY u.id'
...
def get_activities_played_counter(request):
    ...
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + ' AND a.id_elemento IN (27101,27102,27103)' + query_params + ' GROUP BY a.id_elemento;'
...
def get_activities_played_counterRC(request):
    ...
    final_base = ' a.usuario_id = u.id && b.usuario_id = a.usuario_id && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + ' AND a.actividad_id IN (9005,9006,9007,9008)' + query_params + ' GROUP BY a.actividad_id;'
...
def get_porcentaje_llave(request):
    ...
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " AND pertenece.nivel_id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
...
def get_ElementosReciclados_Tipo(request):
    ...
    hi = "SELECT CONCAT(usuario.nombres, ' ',usuario.apellido_paterno, ' ',usuario.apellido_materno) AS nombre,COUNT(alumno_respuesta_actividad.correcta) AS Totales,SUM(alumno_respuesta_actividad.correcta = 0) AS incorrectas,SUM(alumno_respuesta_actividad.correcta = 1) AS Correctas, pertenece.colegio_id, pertenece.nivel_id, alumno_respuesta_actividad.columna FROM usuario INNER JOIN alumno_respuesta_actividad ON usuario.id = alumno_respuesta_actividad.id_user INNER JOIN pertenece ON pertenece.usuario_id = alumno_respuesta_actividad.id_user INNER JOIN elemento ON alumno_respuesta_actividad.id_elemento = elemento.id WHERE correcta != 2" + query_params + " GROUP BY alumno_respuesta_actividad.columna"
    #print(hi)
    return hi
...
def get_cantidad_sesiones_por_curso(request):
    ...
    start_base = ' SELECT  concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, COALESCE(round(count((if(a.id_elemento=2128,1,null)))/count((if (a.id_elemento=2031,1,null)))),0) AS CantidadTouch, b.colegio_id, b.nivel_id '
...
def get_sesiones(request):
    ...
    final_base = ' b.colegio_id IN (SELECT colegio_id from pertenece p INNER JOIN usuario u1 ON (p.usuario_id = u1.id) WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY b.colegio_id'
    return start_base + final_base
...
def get_tiempo_promedio(request):
    ...
    final_base += ' AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY u.id'
...
def get_solicitudes(request):
    ...
    sql +=' AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))'
...
def get_desafios_porcentual_vocales(request):
    ...
    sql +=' WHERE '  + date
    sql +=' b.colegio_id IN (SELECT colegio_id from pertenece p INNER JOIN usuario u1 ON (p.usuario_id = u1.id) WHERE username="' + request.user.username + '")'
    sql +=' AND b.nivel_id_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))'
...
def get_no_desafios(request):
    ...
    if request.GET.get('reim') and request.GET.get('reim') != '0':
        query_params += " AND a.reim_id = " + request.GET.get('reim')
    if request.GET.get('course') and request.GET.get('course') != '0':
        query_params += " b.nivel_id = " + request.GET.get('course')
    if request.GET.get('letter') and request.GET.get('letter') != '0':
        query_params += " AND b.letra_id = " + request.GET.get('letter')
    if request.GET.get('school') and request.GET.get('school') != '0':
        query_params += " AND b.colegio_id = " + request.GET.get('school')
...
def get_time_act_RCOTotal(request):
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, IF (ROUND((SUM(TIMESTAMPDIFF(SECOND, a.inicio, a.final))))/60<1, 1,ROUND(SUM(TIMESTAMPDIFF(SECOND, a.inicio, a.final))/60)) as total_min FROM tiempoxactividad a, usuario u, pertenece b , letra l , nivel niv, colegio co WHERE' + date
    final_base = ' l.id=b.letra_id and b.nivel_id = niv.id and a.usuario_id = u.id and b.usuario_id=u.id and co.id = b.colegio_id' + query_params + ' and a.actividad_id > 8999 AND a.actividad_id < 9011 group by u.id;'
    print(start_base + final_base)
    return start_base + final_base
...
def get_analytics1_1_co_act_3(request):
    ...
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(if(a.id_elemento=290036,1,NULL)) Actividad1, count(if(a.id_elemento=290034,1,NULL)) Actividad2, count(if(a.id_elemento=290037,1,NULL)) Actividad3, count(if(a.id_elemento=290035,1,NULL)) Actvidad4, b.colegio_id, b.nivel_id FROM alumno_respuesta_actividad a, usuario u, pertenece b where' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON pertenece.usuario_id = usuario.id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + query_params + ' GROUP BY u.id'
    return start_base + final_base
...
def get_activities_played_counterPYL(request):
    ...
    start_base = 'SELECT a.id_elemento as idElemento, count(1) as counter FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + ' AND a.id_elemento IN (280000,280001,280002, 280004)' + query_params + ' GROUP BY a.id_elemento;'
...
def get_activities_played_counterSPACE(request):
    ...
    start_base = 'SELECT a.id_elemento as idElemento, count(1) as counter FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + ' AND a.id_elemento IN (500005,500006,500007,500008,500011,500054,500000)' + query_params + ' GROUP BY a.id_elemento;'
...
def SPACE_getTimer(request):
    ...
    start_base = '  SELECT u.id,  concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(CAST(AVG(second(datetime_touch)) as DECIMAL(5,2))) as promTiempo FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
...
def get_AbandonaDesafioxsession_SPACE(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, count(a.id_user) AS ocurrecias FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user AND (a.id_elemento=4) ' + query_params + ' GROUP BY day(a.datetime_touch) ORDER BY a.datetime_touch ASC'
    return start_base + final_base
...
def get_NaveIntentos_SPACE(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT u.id, concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, count(if(a.id_elemento=8,1,NULL)) Intentos FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user' + query_params + ' GROUP BY u.id'
    return start_base + final_base
...
def get_sonidoIntentoxsession_SPACE(request):
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, count(if(a.id_elemento=8,1,NULL)) Intentos, count(if(a.id_elemento=500105,1,NULL)) Correcto FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user  ' + query_params + ' GROUP BY day(a.datetime_touch) ORDER BY a.datetime_touch ASC'
    return start_base + final_base
...
def get_siembrasxsession_SPACE(request):
    cursor = get_from_db()
    query_params = ''
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, count(a.id_user) AS ocurrecias FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user AND a.id_elemento=500049 ' + query_params + ' GROUP BY day(a.datetime_touch) ORDER BY a.datetime_touch ASC'
    return start_base + final_base

def get_cosechasxsession_SPACE(request):
    cursor = get_from_db()
    query_params = ''
    ...
    date = get_date_param_alumno_respuesta_actividad(request)
    start_base = 'SELECT concat(u.nombres ," ", u.apellido_paterno ," ", u.apellido_materno) as nombre, concat(day(datetime_touch),"/",month(datetime_touch),"/", year(datetime_touch)) AS fecha, count(a.id_user) AS ocurrecias FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user= u.id && b.usuario_id = a.id_user AND a.id_elemento=500051 ' + query_params + ' GROUP BY day(a.datetime_touch) ORDER BY a.datetime_touch ASC'
    return start_base + final_base
...
def get_elements_played_counterSPACE(request):
    ...
    start_base = 'SELECT a.id_elemento as idElemento, count(1) as counter FROM alumno_respuesta_actividad a, usuario u, pertenece b WHERE' + date
    final_base = ' a.id_user = u.id && b.usuario_id = a.id_user && b.colegio_id IN (SELECT colegio_id from pertenece INNER JOIN usuario ON usuario.id = pertenece.usuario_id WHERE username="' + request.user.username + '") AND b.nivel_id IN (SELECT nivel_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '")) AND b.letra_id IN (SELECT letra_id FROM pertenece WHERE usuario_id = (SELECT id FROM usuario WHERE username = "' + request.user.username + '"))' + ' AND a.id_elemento IN (500070,500071,500072,500073,500074,500075,500076,500077,500078,500079,500080,500081,500082,500083,500084,500085,500086,500087,500088,500089)' + query_params + ' GROUP BY a.id_elemento;'
